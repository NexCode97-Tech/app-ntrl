...
export default function MonthPicker({ value, currentMonth, availableMonths = [], dateRange, onChange, alignRight = false }) {
  ...
  return (
    <div ref={ref} className="relative">
      ...
      <button
        onClick={() => setOpen((p) => !p)}
        className="flex items-center gap-2 bg-zinc-800 border border-zinc-700 hover:border-zinc-500 text-zinc-400 hover:text-white text-xs rounded-lg px-3 py-1.5 transition-colors focus:outline-none focus:border-brand-green"
      >
